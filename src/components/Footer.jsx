...
function Footer(){
    return(
       <div style={{display:'flex', background:'rgb(153, 2, 2)', padding: '10px', color:'white'}}>
        ...
        <img  style={{marginTop:"1.4%", height:"20px", width:"20px"}} src={Loc} alt=""></img><p style={{paddingLeft:"5px" ,paddingRight:"90px"}}>House 1, Street3, Lane 10, Hostel City park Road Islamabad</p>
